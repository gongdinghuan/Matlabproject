classdef imageApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            imageApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'tuxiang')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong tuxiang
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'tuxiang').getString, ...
            ...
            if nargout(@tuxiang) == 0
                eval('tuxiang');
            else
                obj.AppHandle = eval('tuxiang');
            end
