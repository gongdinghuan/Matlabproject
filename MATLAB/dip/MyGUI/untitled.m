...
% Last Modified by GUIDE v2.5 23-May-2019 10:58:59
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
num_1=get(handles.num_1,'string');
data_1_num = str2num(num_1);
num_2=get(handles.num_2,'string');
data_2_num = str2num(num_2);
sum_num = data_1_num + data_2_num;
str_num = num2str(sum_num);
i = imread('cameraman.tif');
figure;
imshow(i);
set(handles.out,'string',str_num);
